...
<li class="vevent <?php echo $class; ?>">
	<span class="gigpress-sidebar-date">
		<span class="dtstart" title="<?php echo $showdata['iso_date']; ?>"><?php echo $showdata['date']; ?></span>
		<?php if($showdata['end_date']) : ?>
			 - <span class="dtend" title="<?php echo $showdata['iso_end_date']; ?>"><?php echo $showdata['end_date']; ?></span>
		<?php endif; ?>
	</span>
	<span class="summary">
